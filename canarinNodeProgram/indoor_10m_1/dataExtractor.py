...
# ========================================================
LOG_FILE_NAME = 'indoor_ten_meters_1.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoors10meters1.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_10meters_trial_1'  # <--- Name for your graph
# ========================================================
