...
# ========================================================
LOG_FILE_NAME = 'indoor_ten_meters_3.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor10meter3.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_10meters_trial_3'  # <--- Name for your graph
# ========================================================
