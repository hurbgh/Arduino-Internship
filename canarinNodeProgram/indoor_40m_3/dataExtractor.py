...
# ========================================================
LOG_FILE_NAME = 'indoor_forty_meters_3.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor40meter3.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_40meters_trial_3'  # <--- Name for your graph
# ========================================================
