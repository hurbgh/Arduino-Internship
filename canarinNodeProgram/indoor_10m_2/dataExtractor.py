...
# ========================================================
LOG_FILE_NAME = 'indoor_ten_meters_2.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor10meter2.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_10meters_trial_2'  # <--- Name for your graph
# ========================================================
