...
# ========================================================
LOG_FILE_NAME = 'indoor_thirty_meters_3.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor30meter3.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_30meters_trial_3'  # <--- Name for your graph
# ========================================================
