...
# ========================================================
LOG_FILE_NAME = 'classrooms_obstacle_1.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Classroomobstacle1.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'classroomObstacle_Trial_1'  # <--- Name for your graph
# ========================================================
