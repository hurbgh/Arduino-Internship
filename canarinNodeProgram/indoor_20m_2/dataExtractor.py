...
# ========================================================
LOG_FILE_NAME = 'indoor_twenty_meters_2.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor20meter2.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_20meters_trial_2'  # <--- Name for your graph
# ========================================================
