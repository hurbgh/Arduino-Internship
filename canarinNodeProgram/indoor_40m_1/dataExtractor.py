...
# ========================================================
LOG_FILE_NAME = 'indoor_forty_meters_1.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor40meter1.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_40meters_trial_1'  # <--- Name for your graph
# ========================================================
