...
# ========================================================
LOG_FILE_NAME = 'classrooms_obstacle_3.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Classroomobstacle3.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'classroomObstacle_Trial_3'  # <--- Name for your graph
# ========================================================
