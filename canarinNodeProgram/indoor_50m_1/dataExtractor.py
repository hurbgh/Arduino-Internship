...
# ========================================================
LOG_FILE_NAME = 'indoor_fifty_meters_1.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor50meter1.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_50meters_trial_1'  # <--- Name for your graph
# ========================================================
