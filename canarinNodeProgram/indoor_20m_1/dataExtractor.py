...
# ========================================================
LOG_FILE_NAME = 'indoor_twenty_meters_1.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor20meter1.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_20meters_trial_1'  # <--- Name for your graph
# ========================================================
