...
# ========================================================
LOG_FILE_NAME = 'indoor_thirty_meters_1.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor30meter1.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_30meters_trial_1'  # <--- Name for your graph
# ========================================================
