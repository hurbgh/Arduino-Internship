...
# ========================================================
LOG_FILE_NAME = 'indoor_twenty_meters_3.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor20meter3.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_20meters_trial_3'  # <--- Name for your graph
# ========================================================
