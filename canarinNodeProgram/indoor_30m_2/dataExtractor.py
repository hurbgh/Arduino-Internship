...
# ========================================================
LOG_FILE_NAME = 'indoor_thirty_meters_2.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor30meter2.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_30meters_trial_2'  # <--- Name for your graph
# ========================================================
