...
# ========================================================
LOG_FILE_NAME = 'indoor_forty_meters_2.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor40meter2.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_40meters_trial_2'  # <--- Name for your graph
# ========================================================
