...
# ========================================================
LOG_FILE_NAME = 'indoor_fifty_meters_3.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Indoor50meter3.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'Indoor_50meters_trial_3'  # <--- Name for your graph
# ========================================================
