...
# ========================================================
LOG_FILE_NAME = 'classrooms_obstacle_2.log'  # <--- Your .log (JSON) file
CSV_FILE_NAME = 'Classroomobstacle2.csv' # <--- Your .csv (Phone) file
TRIAL_LABEL = 'classroomObstacle_Trial_2'  # <--- Name for your graph
# ========================================================
